...
from utility.utils import get_correct_sj_salary, correct_hh_salary, get_correct_experience_sj
...
class HH(Engine):
    ...
    def get_request(self, name_vacancy: str = 'python'):
        """ Функция обращается к API и
         записывает в файл информацию по всем вакансиям по ключевому слову в формате json """
