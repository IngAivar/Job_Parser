...
4. На консоли вы сможете ознакомится с отфильтрованными и отсортированными данными. Теперь вам останется только нажать Enter чтобы завершить работу программы.
